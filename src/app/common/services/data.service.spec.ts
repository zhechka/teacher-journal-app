...
describe('DataService', () => {
  it('should return expected array of students', () => {
    ...
    dataService.getStudents().subscribe(students => {
  ...
  it('should return expected array of subjects', () => {
    ...
    dataService.getSubjects().subscribe(subjects => {
